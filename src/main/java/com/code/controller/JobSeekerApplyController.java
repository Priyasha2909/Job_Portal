...
import com.code.services.JobPostActivityService;
import com.code.services.JobSeekerApplyService;
import com.code.services.JobSeekerProfileService;
import com.code.services.JobSeekerSaveService;
import com.code.services.RecruiterProfileService;
import com.code.services.UsersService;
...
public class JobSeekerApplyController {
	...
	public String display(@PathVariable("id") int id, Model model) {
		...
		//after getting data from db adding to model to display to user
	...
	//persist the job when user applies
